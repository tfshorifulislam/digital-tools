        ...
        <div className='w-11/12 mx-auto'>
            ...
            {selectedCards.length === 0 && <div className='flex justify-center items-center'>
                <div className='flex justify-center items-center flex-col my-20'>
                    <BsCartXFill className='text-7xl  opacity-40' />

                    <p className='text-lg font-medium mt-2 mb-4 opacity-40'>No Items Found</p>
                    <button
                        onClick={() => setMainSectionBtnToggle('Products')}
                        className='btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white rounded-full'>Go Back Products
                    </button>
                </div>
            </div>}
